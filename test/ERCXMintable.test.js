...
contract("Item", accounts => {
  ...
  describe("like a mintable ERCX", function() {
    ...
    describe("test cases for basic ERCX", function(){
      ...
      describe("balanceOf in ERCX", function() {
        ...
        context(
          "when the given layer was higher than layer 2",
          function() {
            it("returns 0", async function() {
    ...
    describe("test cases for ERCX721fier", function(){
    ...
    describe("test cases for Metadata", function() {
    ...
    describe("test cases for Enumerables", function(){
    ...
    describe("test cases for Burn and Mint", function(){
