...
contract ERCX is ERC165, IERCX {
  ...
  bytes4 private constant _ERCX_Ownership_RECEIVED = bytes4(keccak256("onERCXOwnershipReceived(address,address,uint256,bytes)"));
  bytes4 private constant _ERCX_SuperOwnership_RECEIVED = bytes4(keccak256("onERCXSuperOwnershipReceived(address,address,uint256,bytes)"));
  bytes4 private constant _ERCX_HyperOwnership_RECEIVED = bytes4(keccak256("onERCXHyperOwnershipReceived(address,address,uint256,bytes)"));
  ...
  mapping (address => uint256) private _superOwnershipTokensCount;9
